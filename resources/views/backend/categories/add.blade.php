            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    {!! Form::open(array('route' => 'backend.categories.add', 'enctype'=>'multipart/form-data', 'id' => 'demo-form2', 'data-parsley-validate' => '', 'class' => 'form-horizontal form-label-left', 'novalidate ' => '')) !!}
                      <!-- name -->
                      ...
                      <div class="form-group {{ $str }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tag" class="form-control col-md-7 col-xs-12" type="text" name="tag" placeholder="Tag">
                          @if ($errors->first('tag'))
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="orderby" class="date-picker form-control col-md-7 col-xs-12" type="text" name="orderby" value="{{ old('orderby') }}" placeholder="Order by">
                        </div>
                      </div>
