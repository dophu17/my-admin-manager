...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Modules <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('backend.users') }}">Users</a></li>
                      <li><a href="{{ route('backend.categories') }}">Categories</a></li>
                      <li><a href="{{ route('backend.products') }}">Products</a></li>
    ...
    <script src="{{ asset('') }}public/backend/js/myjs.js"></script>
